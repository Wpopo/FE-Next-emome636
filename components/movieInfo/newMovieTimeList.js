  ...
  const processData = (dataList) =>
    dataList.map((item) => (
      ...
      >
        ...
        {show_title ? <div className="text_ellipsis">{item.movie_title.zh_tw}</div> : null}
        {show_title ? <div className="eng_title text_ellipsis">{item.movie_title.en_us}</div> : null}
        {show_info ? (
...
export default withStyles(styles)(NewMovieTimeList);
